                ...
                <div id="sidebar">
                    ...
                    <nav id="menu">
                        ...
                        <section id="xclk-section" class="nothidden">
                            <div class="input-group hidden" id="set-xclk-group">
                        ...
                        <div class="input-group hidden" id="framesize-group">
                        ...
                        <div class="input-group hidden" id="quality-group">
                        ...
                        <div class="input-group hidden" id="saturation-group">
                            <label for="saturation">Saturation</label>
                            <div class="range-min">-2</div>
                            <input type="range" id="saturation" min="-2" max="2" value="0" class="default-action">
                            <div class="range-max">2</div>
                        </div>
                        <div class="input-group hidden" id="special_effect-group">
                        ...
                        <div class="input-group hidden" id="awb-group">
                        ...
                        <div class="input-group hidden" id="awb_gain-group">
                        ...
                        <div class="hidden" id="wb_mode-group">
                            <label for="wb_mode"><!--WB Mode--></label>
                            <select id="wb_mode" class="default-action hidden">
                        ...
                        <div class="input-group hidden" id="aec-group">
                        ...
                        <div class="input-group hidden" id="aec2-group">
                        ...
                        <div class="input-group hidden" id="ae_level-group">
                        ...
                        <div class="input-group hidden" id="agc-group">
                        ...
                        <div class="hidden" id="gainceiling-group">
                            <label for="gainceiling"><!--Gain Ceiling--></label>
                            <div class="hidden">2x</div>
                            <input type="range" id="gainceiling" min="0" max="6" value="0" class="default-action hidden">
                            <div class="hidden">128x</div>
                        </div>
                        <div class="input-group hidden" id="bpc-group">
                        ...
                        <div class="input-group hidden" id="wpc-group">
                        ...
                        <div class="input-group hidden" id="raw_gma-group">
                        ...
                        <div class="input-group hidden" id="lenc-group">
                        ...
                        <div class="input-group hidden" id="hmirror-group">
                        ...
                        <div class="input-group hidden" id="vflip-group">
                        ...
                        <div class="input-group hidden" id="dcw-group">
                        ...
                        <div class="input-group hidden" id="colorbar-group">
                        ...
                        <section id="buttons">
                            <button id="get-still" class="hidden">Get Still</button>
                            <button id="toggle-stream">Start Stream</button>
                            <button id="face_enroll" class="hidden class="disabled" disabled="disabled">Enroll Face</button>
                        </section>

                        <div style="margin-top: 8px;"><center><span style="font-weight: bold;"><!--Advanced Settings--></span></center></div>
                        <!--<hr style="width:100%">-->
                        <label for="nav-toggle-reg" class="hidden">&#9776;&nbsp;&nbsp;Register Get/Set</label><input type="checkbox" id="nav-toggle-reg" class="hidden toggle-section-button" checked="checked">
                        ...
                        <!--<hr style="width:100%">-->
                        <label for="nav-toggle-2640pll" class="hidden">&#9776;&nbsp;&nbsp;CLK</label><input type="checkbox" id="nav-toggle-2640pll" class="hidden toggle-section-button" checked="checked">
                        <section class="toggle-section">
                        ...
                        <!--<hr style="width:100%">-->
                        <label for="nav-toggle-win" class="hidden">&#9776;&nbsp;&nbsp;Window</label><input type="checkbox" id="nav-toggle-win" class="hidden toggle-section-button" checked="checked">
                        <section class="toggle-section">
